...
namespace NobatPlusAPI.Controllers
{
    ...
    public class PaymentHistoryController : ControllerBase
    {
        ...
        public async Task<ActionResult<ListResultObject<PaymentHistory>>> GetAllPaymentHistories_Base(GetPaymentHistoryListRequestBody requestBody)
        {
            ...
            var result = await _PaymentHistoryRep.GetAllPaymentHistoriesAsync(requestBody.BookingId,requestBody.PageIndex,requestBody.PageSize,requestBody.SearchText);
            if (result.Status)
            {
                return Ok(result);
            }
