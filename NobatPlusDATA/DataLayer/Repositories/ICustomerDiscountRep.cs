...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<CustomerDiscount>> GetAllCustomerDiscountsAsync(long DiscountId, long CustomerId, long StylistId, int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="");
