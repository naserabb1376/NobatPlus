...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<Payment>> GetAllPaymentsAsync(long bookingId = 0, long customerId = 0, int paymentIncludes = 0, int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="");
