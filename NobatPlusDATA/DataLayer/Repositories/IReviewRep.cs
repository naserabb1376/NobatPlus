...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<Review>> GetAllReviewsAsync(long BookingId = 0, long CustomerId = 0, int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="");
