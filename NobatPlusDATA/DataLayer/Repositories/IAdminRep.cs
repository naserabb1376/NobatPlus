...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<Admin>> GetAllAdminsAsync(int pageIndex = 1, int pageSize = 20, string searchText = "");
        public Task<ListResultObject<Admin>> GetAdminsOfDiscountAsync(long DiscountId, int pageIndex = 1, int pageSize = 20, string searchText = "");
