...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<Admin>> GetAllAdminsAsync(string role ="",long CityId =0,int pageIndex = 1, int pageSize = 20, string searchText = "");
        public Task<ListResultObject<Admin>> GetAdminsOfDiscountAsync(long DiscountId,long cityId=0 ,string role = "", int pageIndex = 1, int pageSize = 20, string searchText = "");
