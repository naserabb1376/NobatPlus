...
namespace NobatPlusDATA.DataLayer.Repositories
{
    ...
    {
        public Task<ListResultObject<StylistServiceWithDiscountDto>> GetAllStylistServicesAsync(long stylistId = 0,long serviceId = 0, long customerId = 0,long bookingId = 0,long discountId = 0,List<long>? optionValueIds = null,bool onlyLeafServices = false,int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="");
        public Task<RowResultObject<StylistServiceWithDiscountDto>> GetStylistServiceByIdAsync(long StylistId, long ServiceManagementId, long customerId = 0,long discountId = 0,List<long>? optionValueIds = null);
